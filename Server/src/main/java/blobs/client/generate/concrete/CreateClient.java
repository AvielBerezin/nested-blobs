...
public class CreateClient {
    public static void main(String[] args) throws IOException {
        identifier("x0").equate(identifier("x1"))
                        .ifStatement()
                        .thenDo(identifier("y0")).inputStream(0).transferTo(System.out);
    }

    public static ScopeStatement createClient() {
        ...
        ImmutableDeclaration sendMovementDeclaration =
                identifier("sendMovement").declareAs(Function.create()
                                                             ...
                                                             .addStatement(identifier("angle").declareAs(identifier("Math").get(identifier("atan"))
                                                                                                                           ...
                                                                                                                           .add(identifier("x").lessThen(literal(0))
                                                                                                                                               .intoNum()
                                                             ...
                                                             .addStatement(identifier("strength").declareAs(identifier("d").subtract(literal(0.1))
                                                                                                                           .divide(literal(0.5).subtract(literal(0.1)))))
                                                             ...
                                                             .conclude(identifier("undefined")));
        Invocation invokeSendMovement =
                identifier("sendMovement").invoke()
                                          ...
                                          .addArgument(identifier("y").subtract(identifier("canvas").get(identifier("height"))
                                                                      ...
                                                                      .multiply(literal(2))
                                                                      .divide(identifier("size")));
        ImmutableDeclaration linearMapDeclaration =
                identifier("linearMap").declareAs(Function.create()
                                                          .addParameter(identifier("x0"))
                                                          .addParameter(identifier("x1"))
                                                          .addParameter(identifier("x"))
                                                          .addParameter(identifier("y0"))
                                                          .addParameter(identifier("y1"))
                                                          .addStatement(identifier("x0").equate(identifier("x1"))
                                                                                        .ifStatement()
                                                                                        .thenDo(identifier("y0")))
                                                          .conclude(identifier("y0").add(identifier("x").multiply(identifier("y1").subtract(identifier("y0")))
                                                                                                        .divide(identifier("x1").subtract(identifier("x0"))))
                                                                                    .returned()));
        ScopeStatement allCode = ScopeStatement.create()
                                                                                                                                                       ...
                                                                                                                                                       .addStatement(drawCircle.apply("blob",
                                                                                                                                                                                      Scope.create()
                                                                                                                                                                                           .conclude(identifier("blob").get(identifier("human"))
                                                                                                                                                                                                                       .ifStatement()
                                                                                                                                                                                                                       .thenDo(literal("red"))
                                                                                                                                                                                                                       .elseDo(literal("yellow")))))
                                                                                                                                                       .conclude(identifier("undefined"))))
                                                                                                 .addStatement(drawCircle.apply("player", literal("green")))
                                                                                                 .conclude(identifier("undefined"))))
                                               .addStatement(identifier("moving").mutableDeclaration())
                                               .addStatement(identifier("moving").assign(literal(false)))
                                               .addStatement(sendMovementDeclaration)
                                               ...
                                               .addStatement(identifier("window").get(identifier("onmousemove"))
                                                                                 .assign(Function.create()
                                                                                                 .addParameter(ObjectDestruction.create()
                                                                                                                                .addEntry(Identifier.of("x"))
                                                                                                                                .addEntry(Identifier.of("y")))
                                                                                                 .addStatement(identifier("moving").not()
                                                                                                                                   .ifStatement()
                                                                                                                                   .thenDo(identifier("undefined")))
                                                                                                 .addStatement(invokeSendMovement)
                                                                                                 .conclude(identifier("undefined"))))
                                               ...
                                               .addStatement(identifier("window").get(identifier("onmousewheel"))
                                                                                 .assign(Function.create()
                                                                                                 ...
                                                                                                 .conclude(identifier("undefined"))));
        return ScopeStatement.create()
                             .addStatement(identifier("window").get(identifier("onload"))
                                                               .assign(Function.create()
                                                                               .addStatement(allCode)
                                                                               .conclude(identifier("undefined"))));
    }
}
